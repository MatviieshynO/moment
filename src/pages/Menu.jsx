    ...
    <div className="flex-row justify-center w-full">
      ...
      >
        <li role="presentation">
          <a
            href="#foot"
            className="mt-[2px] block border-x-0 border-b-2 border-t-0 border-transparent px-10 pb-2 pt-2 text-xs font-medium uppercase leading-tight text-neutral-0 hover:isolate hover:border-transparent hover:bg-black focus:isolate focus:border-transparent data-[te-nav-active]:border-white data-[te-nav-active]:text-white dark:text-neutral-400 dark:hover:bg-transparent dark:data-[te-nav-active]:border-primary-400 dark:data-[te-nav-active]:text-primary-400"
            id="tabs-home-tab3"
            data-te-toggle="pill"
      ...
      <div>
        ...
        >
          ...
          <nav className="flex-column w-full">
            <ul className="navDrinks flex justify-center items-center sticky top-6 pt-2 bg-black text-white text-xs text-center">
              <li className="p-2 ">
